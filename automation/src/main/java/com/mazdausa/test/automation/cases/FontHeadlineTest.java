...
public class FontHeadlineTest  extends BaseTest{

    private WebElement element;

    public FontHeadlineTest(WebDriver driver) {
        this.setDriver(driver);
    }
    public Boolean FontHeadlineTest (int searchContext, String contextValue){
        ...
        try{
            ...
            if(element.getCssValue("font-family").equals("interstate-light,interstatemazda-light,sans-serif,arial")
                    ...
                    ||element.getCssValue("font-size").equals("3em" )) {;
